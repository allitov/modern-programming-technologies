...
public class MainWindow {
    ...
    private void configureFilters() {
        ...
        priorityFilter.addActionListener(event -> updateFilter());
    }
    ...
    private void configureButtons() {
        addTaskButton.addActionListener(event -> addTaskFromForm());
        updateTaskButton.addActionListener(event -> updateTaskFromForm());
        deleteTaskButton.addActionListener(event -> deleteSelectedTask());
        clearButton.addActionListener(event -> clearTaskFields());
        addProjectButton.addActionListener(event -> addProjectFromDialog());
        deleteProjectButton.addActionListener(event -> deleteSelectedProject());
    }
